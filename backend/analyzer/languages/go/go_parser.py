...
class GoParser(BaseParser):
    """Parses Go source code into a Tree-sitter AST."""
    ...
    def parse(self, source_code: str) -> NormalizedSyntaxTree:
        ...
        if root.has_error:
            ...
            raise SyntaxError(f"Go syntax error at line {line}", ("code", line, 1, source_code))

        return NormalizedSyntaxTree(raw_tree=tree, source_code=source_code, language_id="go")
