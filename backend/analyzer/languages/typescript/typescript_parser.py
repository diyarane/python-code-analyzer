"""TypeScript & TSX parser implementation using Tree-sitter."""
...
class TypeScriptParser(BaseParser):
    """Parses TypeScript and TSX source code into a Tree-sitter AST."""

    def __init__(self, is_tsx: bool = False):
        self.is_tsx = is_tsx
        self._parser = get_parser("tsx" if is_tsx else "typescript")
    ...
    def parse(self, source_code: str) -> NormalizedSyntaxTree:
        ...
        if root.has_error:
            ...
            raise SyntaxError(f"TypeScript syntax error at line {line}", ("code", line, 1, source_code))

        lang_id = "typescript_tsx" if self.is_tsx else "typescript"
